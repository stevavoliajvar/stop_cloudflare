...
Ez a lerakat azon webhelyek listáját tartalmazza, amelyek mögött vannak a "_A nagy felhőfal_", blokkolja a Tor felhasználóit és más CDN-ket.
...
* [Anti-Tor felhasználók](../anti-tor_users/)
...
* [Blokkolja a globális aktív ellenséges felhőkarcolást](https://trac.torproject.org/projects/tor/ticket/24351) nym-zone szerint
  * A jegy oly sokszor vandalizált.
  * Törölte a [Tor Project](https://lists.torproject.org/pipermail/anti-censorship-team/2020-May/000098.html). Lásd: [jegy 34175](https://trac.torproject.org/projects/tor/ticket/34175).
  * Utolsó [archív jegy 24351](https://web.archive.org/web/20200301013104/https://trac.torproject.org/projects/tor/ticket/24351)
* [Cloudflare probléma](https://github.com/privacytoolsIO/privacytools.io/issues/374#issuecomment-460077544) írta: libBletchley
  * A Cloudflare-t a múltban is használták. Hozzáadott CF-tor, de [eltávolítva](https://github.com/privacytools/privacytools.io/pull/1804).
* [Cloudflare Watch](http://www.crimeflare.org:82/)
* [Kritika és viták](https://en.wikipedia.org/wiki/Cloudflare#Criticism_and_controversies) a Wikipedia által
* [Egy újabb mérföldkő a háborúban az internet ellenőrzése, központosítása és cenzúrálása céljából.](https://www.reddit.com/r/privacy/comments/b8dptl/another_landmark_day_in_the_war_to_control/), TheGoldenGoose8888 készítette
* [Csak egy szolgáltatásra támaszkodó hátrányok](https://twitter.com/w3Nicolas/status/1134529316904153089) ([DO is CF](https://www.digwebinterface.com/?hostnames=ns1.digitalocean.com % 0D% 0Ans2.digitalocean.com% 0D% 0Ans3.digitalocean.com% 0D% 0Awww.digitalocean.com & type = A & ns = rezolver & useresolver = 8.8.4.4 & névszervereinek =))
...
* Olvassa el [az ajánlott műveletek listáját](../what-to-do.md), és ossza meg barátaival.

* Olvassa el a [másik felhasználó hangját](../PEOPLE.md) és írja meg gondolatait.

* Keressen valamit a [Ansero] -on (https://ansero.wodferndripvpe6ib4uz4rtngrnzichnirgn7t5x64gxcyroopbhsuqd.onion/) ([clearnet](https://ansero.eu.org/)) vagy a [Crimeflare \ #Search](https://bűncselekmény). wodferndripvpe6ib4uz4rtngrnzichnirgn7t5x64gxcyroopbhsuqd.onion/) ([clearnet](https://crimeflare.eu.org/)).

* Frissítse a domain listát: [Az utasítások listája](instrukcijas.md).

* Adjon hozzá Cloudflare-t vagy egy projekttel kapcsolatos eseményt a [történelem] -hez (../HISTORY.md).

* Próbálja ki és írjon új [Szerszám/Szkript](eszköz/) elemet.

* Itt van néhány [PDF/ePUB](../pdf/), amelyet el kell olvasni.
