...
"Ваша компания не заслуживает доверия. Вы заявляете о соблюдении Закона США "Об авторском праве в цифровую эпоху" (DMCA), но имеете множество судебных исков за невыполнение этого требования"
...
Если вы разместите в Twitter текст, направленный против Cloudflare, у вас будет шанс получить ответ от сотрудника Cloudflare с сообщением «Нет, это не так».
...
Если вы не хотите, чтобы вас беспокоили, нападали, били или убивали, вам лучше держаться подальше от веб-сайтов Cloudflared.
...
CloudFlare отдает предпочтение тем, кто использует Firefox, и враждебно относится к пользователям, не использующим Tor-Browser, а не Tor.
...
| Chromium or Firefox (Javascript отключен) | в доступе отказано |
| Chromium or Firefox (Cookie отключен) | в доступе отказано |
| QuteBrowser | в доступе отказано |
| lynx | в доступе отказано |
| w3m | в доступе отказано |
| wget | в доступе отказано |
...
Обратите внимание, что бумажная регистрация не обходит Cloudflare, потому что сотрудники штата по вводу данных государственного секретаря, скорее всего, будут использовать веб-сайт Cloudflare для ввода данных.
