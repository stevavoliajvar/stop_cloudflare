...
Is liosta é an stór seo de shuíomhanna Gréasáin atá taobh thiar de “_The Great Cloudwall_”, ag cur bac ar úsáideoirí Tor agus CDNanna eile.


** Sonraí **
* [Cloudflare Inc.](../cloudflare_inc/)
* [Úsáideoirí Cloudflare](../cloudflare_users/)
* [Fearainn Cloudflare](../cloudflare_users/fearainn/)
* [Úsáideoirí CDN neamh-Cloudflare](../not_cloudflare/)
* [Úsáideoirí frith-Tor](frith-tor_users/)
...
* [Blockflare Adversary Active Adversary Cloud](https://trac.torproject.org/projects/tor/ticket/24351) de réir nym-zone
  * Rinneadh loitiméireacht ar an ticéad an oiread sin uaireanta.
  * Scriosta ag an [Tionscadal Tor](https://lists.torproject.org/pipermail/anti-censorship-team/2020-May/000098.html). Féach [ticéad 34175](https://trac.torproject.org/projects/tor/ticket/34175).
  * Last [ticéad cartlainne 24351](https://web.archive.org/web/20200301013104/https://trac.torproject.org/projects/tor/ticket/24351)
* [Fadhb le Cloudflare](https://github.com/privacytoolsIO/privacytools.io/issues/374#issuecomment-460077544) le libBletchley
  * Bhí Cloudflare in úsáid acu roimhe seo. Cuireadh CF-tor leis ach [bhain sé é](https://github.com/privacytools/privacytools.io/pull/1804).
* [Faire Cloudflare](http://www.crimeflare.org:82/)
* [Léirmheastóireacht agus conspóidí](https://en.wikipedia.org/wiki/Cloudflare#Criticism_and_controversies) le Wikipedia
* [Lá suntasach eile sa chogadh chun an t-idirlíon a rialú, a lárú agus a chinsireacht.](https://www.reddit.com/r/privacy/comments/b8dptl/another_landmark_day_in_the_war_to_control/) le TheGoldenGoose8888
* [Míbhuntáiste a bheith ag brath ar sheirbhís amháin] [https://twitter.com/w3Nicolas/status/1134529316904153089) ([DO is CF](https://www.digwebinterface.com/?hostnames=ns1.digitalocean.com % 0D% 0Ans2.digitalocean.com% 0D% 0Ans3.digitalocean.com% 0D% 0Awww.digitalocean.com & type = A & ns = athscríobh & useresolver = 8.8.4.4 & nameservers =))
...
* Cuardaigh rud éigin ar [Ansero](https://ansero.wodferndripvpe6ib4uz4rtngrnzichnirgn7t5x64gxcyroopbhsuqd.onion/) ([clearnet](https://ansero.eu.org/)) nó [Crimeflare \ #Search](https://Crimeflare. wodferndripvpe6ib4uz4rtngrnzichnirgn7t5x64gxcyroopbhsuqd.onion/) ([clearnet](https://crimeflare.eu.org/)).

* Nuashonraigh an liosta fearainn: [Treoracha liosta](treoracha.md).

* Cuir Cloudflare nó imeacht a bhaineann le tionscadal le [stair](../HISTORY.md).

* Bain triail as & scríobh [Uirlis/Script] nua (uirlis/).

* Seo roinnt [PDF/ePUB](../pdf/) le léamh.
...
Tá a fhios ag Crimeflare faoi chuntais bhréige a bheith ann a dhéanann aithris ar ár gcainéil oifigiúla, bíodh sé Twitter, Facebook, Patreon, OpenCollective, Villages etc.
