...
"あなたの会社は信用できません。あなたはDMCAを施行すると主張しますが、そうしないとの多くの訴訟があります。"

"彼らは自分たちの倫理に疑問を抱く人々だけを検閲する。"

"真実は不便であり、公衆の目から隠されていると思います。"  -- [phyzonloop](https://twitter.com/phyzonloop)
...
Cloudflareは、Cloudflare以外のユーザーにスパムメールを送信しています。

- オプトインした加入者にのみメールを送信する
- ユーザーが「停止」と言うと、メールの送信を停止します

とても簡単です。しかし、Cloudflareは気にしません。
Cloudflareは、サービスを利用することですべてのスパマーや攻撃者を阻止できると語った。
...
Cloudflare検閲による否定的なレビュー。
TwitterにCloudflareのアンチテキストを投稿すると、Cloudflareの従業員から「いいえ、違います」というメッセージが返される可能性があります。
否定的なレビューをレビューサイトに投稿すると、彼らはそれを検閲しようとします。
...
Cloudflareには、嫌がらせに関する大きな問題があります。
Cloudflareは、ホストされているサイトについて不平を言う人の個人情報を共有します。
彼らはあなたに本当のIDを提供するように頼むことがあります。
嫌がらせを受けたり、暴力を受けたり、殴られたり、殺されたりしたくない場合は、Cloudflared Webサイトから離れたほうがよいでしょう。
...
アメリカの企業が正当な理由のある非営利団体と一緒に慈善事業を求めるのは非常に恐ろしいことです。
...
サイトが突然ダウンした場合はどうしますか？
Cloudflareが警告なしにユーザーの設定を削除したり、サービスを停止したりしているという報告があります。
...
このアクセスの不平等は、ネットワークの中立性の乱用と権力の乱用です。
...
- Tor（Clearnet IP）なしのQuteBrowser（マイナーブラウザー）

| ***ブラウザ*** | ***アクセス治療*** |
| --- | --- |
| Tor Browser (JavaScriptが有効) | アクセス許可 |
...
オーディオボタンを使用して簡単な課題を解決してみませんか？

はい、音声ボタンはありますが、Torでは常に機能しません。
クリックするとこのメッセージが表示されます:

```
あとでもう一度試してみてください
コンピュータまたはネットワークが自動クエリを送信している可能性があります。
ユーザーを保護するため、現在リクエストを処理できません。
詳しくはヘルプページをご覧ください
```
...
CloudflareはTorユーザーを敵対的に扱い、監視の中心的なグローバルポイントとしてのMITMの位置を占め、その有害な役割は全体として有権者の登録を躊躇させています。
特に自由党はプライバシーを受け入れる傾向があります。
有権者登録フォームは、有権者の政治的傾向、個人の住所、社会保障番号、および生年月日に関する機密情報を収集します。
ほとんどの州では、その情報のサブセットのみが公開されていますが、Cloudflareは、誰かが投票に登録したときにすべての情報を参照します。

州のデータ入力スタッフの秘書官がCloudflare Webサイトを使用してデータを入力する可能性が高いため、紙の登録はCloudflareを迂回しないことに注意してください。

| 🖼 | 🖼 |
| --- | --- |
| ![](https://codeberg.org/crimeflare/cloudflare-tor/media/branch/master/image/cfvotm_01.jpg) | ![](https://codeberg.org/crimeflare/cloudflare-tor/media/branch/master/image/cfvotm_02.jpg) |

- Change.orgは、投票を集めて行動を起こす有名なWebサイトです。
“世界中の人々がキャンペーンを開始し、支持者を動員し、意思決定者と協力してソリューションを推進しています。”
残念ながら、Cloudflareのアグレッシブフィルターにより、多くの人はchange.orgをまったく見ることができません。
彼らは請願書に署名することからブロックされており、民主的なプロセスから彼らを排除しています。
OpenPetitionなどの他の非クラウドフレアプラットフォームを使用すると、問題の解決に役立ちます。

| 🖼 | 🖼 |
| --- | --- |
| ![](https://codeberg.org/crimeflare/cloudflare-tor/media/branch/master/image/changeorgasn.jpg) | ![](https://codeberg.org/crimeflare/cloudflare-tor/media/branch/master/image/changeorgtor.jpg) |

- Cloudflareの「Athenian Project」は、州および地方選挙のWebサイトに無料のエンタープライズレベルの保護を提供します。
...
無料プランをご利用の場合、月額プランの購入を求めるメールが送信されることがあります。
...
それが本当に削除された場合、この元の顧客はなぜメールを受け取ったのですか？
...
プライバシーポリシーがLIEである場合、Cloudflareをどのように信頼できますか？
...
削除をリクエストする前に、アカウントにドメインやクレジットカードを添付してはいけません。
```
...
「削除リクエストの処理を開始しました」「個人情報の保存は継続します」
