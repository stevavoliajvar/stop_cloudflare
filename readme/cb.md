...
| Gitawag kini kini sa pagtumong sa Great Firewall sa China nga adunay usa ka susama nga trabaho sa pagsala sa daghang mga tawo gikan sa pagtan-aw sa sulud sa web (ie ang tanan sa mainland China ug mga tawo sa gawas) samtang sa susamang panahon kadtong wala maapektuhan makakita sa usa ka lahi nga lahi sa web , usa ka web nga libre sa pagsensor sama sa imahe sa "tank man" ug ang kasaysayan sa "Tiananmen Square protesta". | ![](https://codeberg.org/crimeflare/cloudflare-tor/media/branch/master/image/cloudflarechina.jpg) |
...
| Dili nimo maipasa kining invasive "browser check" nga wala’y pagtugot sa Javascript. Kini usa ka basura sa lima (o daghan pa) nga mga segundo sa imong bililhon nga kinabuhi. | ![](https://codeberg.org/crimeflare/cloudflare-tor/media/branch/master/image/omsjsck.jpg) |
| Ang Cloudflare usab awtomatiko nga gibabagan ang mga legit robots/crawler sama sa mga kliyente sa Google, Yandex, Yacy, ug API. Ang Cloudflare aktibo nga nag-monitor sa "bypass cloudflare" nga komunidad nga adunay katuyoan nga mabungkag ang mga bot sa panukiduki. | ![](https://codeberg.org/crimeflare/cloudflare-tor/media/branch/master/image/cftestgoogle.jpg) |
| Ang Cloudflare parehas nga nagpugong sa daghang mga tawo nga adunay dili maayo nga koneksyon sa internet gikan sa pag-access sa mga website sa luyo niini (pananglitan, mahimo sila nga sa likod sa 7+ mga layer sa NAT o sa pagpaambit sa parehas nga IP, pananglitan sa publiko nga Wifi) gawas kung masulbad nila ang daghang mga imahe sa CAPTCHA. Sa pipila ka mga kaso, kini molungtad sa 10 hangtod 30 minuto aron matagbaw ang Google. | ![](https://codeberg.org/crimeflare/cloudflare-tor/media/branch/master/image/googlerecaptcha.jpg) |
| Sa tuig 2020 ang Cloudflare gibalhin gikan sa Recaptcha sa Google ngadto sa hCaptcha samtang ang Google nagtinguha nga maningil alang sa paggamit niini. Giingon ka sa Cloudflare nga giatiman nila ang imong privacy ("makatabang kini pagsulbad sa usa ka kabalaka sa privacy") apan kini klaro nga bakak. Naa tanan bahin sa kuwarta. "Gitugotan sa hCaptcha ang mga website nga makagasto sa pag-alagad sa kini nga panginahanglan samtang gibabagan ang mga bot ug uban pang mga porma sa pag-abuso" Napilitan ka sa pagsulbad niini. | ![](https://codeberg.org/crimeflare/cloudflare-tor/media/branch/master/image/fedup_fucking_hcaptcha.jpg) |
...
| Unsa ang katuyoan sa internet kung dili nimo mahimo ang imong gusto? Kadaghanan sa mga tawo nga mobisita sa imong website mangita lang sa ubang mga panid kung dili sila maka-load sa usa ka webpage. Mahimo nga dili nimo gibabagan ang bisan kinsa nga mga bisita, apan ang default firewall nga default sa Cloudflare nga igo aron mapugngan ang daghang mga tawo. | ![](https://codeberg.org/crimeflare/cloudflare-tor/media/branch/master/image/omsdroid.jpg) <br>![](https://codeberg.org/crimeflare/cloudflare-tor/media/branch/master/image/omsappl.jpg) |
...
| Kung wala nimo pagsulay si Tor hangtod niining higayona, gidasig ka namon nga mag-download sa Tor Browser ug bisitahan ang imong mga paboritong website. (tambag: Ayaw pag-login sa imong website sa bangko o webpage sa gobyerno o pag-flag nila ang imong account. Paggamit VPN alang sa mga website.) | ![](https://codeberg.org/crimeflare/cloudflare-tor/media/branch/master/image/banvpn.jpg) |
| Mahimo nimong isulti nga "Ang Tor ilegal! Ang mga tiggamit sa Tor mga kriminal! Ang Tor daotan!". Mahimo nimo mahibal-an ang bahin sa Tor gikan sa telebisyon, giingon nga ang Tor mahimong magamit sa pag-browse sa darknet ug mga baril sa patigayon, mga droga o chid porn. Samtang ang pahayag sa ibabaw tinuod nga adunay daghang website sa merkado diin mahimo nimo mapalit ang ingon nga mga butang, kana nga mga site kanunay nga makita usab sa clearnet. | ![](https://codeberg.org/crimeflare/cloudflare-tor/media/branch/master/image/whousetor.jpg) |
...
| Ug ang ilang serbisyo sa DNS, 1.1.1.1, usab ang pagsala sa mga tiggamit gikan sa pagbisita sa website pinaagi sa pagbalik sa peke nga IP address nga gipanag-iya sa Cloudflare, localhost IP sama sa "127.0.0.x", o pagbalik lang wala. | ![](https://codeberg.org/crimeflare/cloudflare-tor/media/branch/master/image/cferr1016.jpg) <br>![](https://codeberg.org/crimeflare/cloudflare-tor/media/branch/master/image/cferr1016sp.jpg) |
| Ang Cloudflare DNS usab nagbungkag sa online software gikan sa smartphone app hangtod sa dula sa kompyuter tungod sa ilang peke nga tubag sa DNS. Ang Cloudflare DNS dili mahimong mangutana sa pipila ka mga website sa bangko. | ![](https://codeberg.org/crimeflare/cloudflare-tor/media/branch/master/image/cfdnsprob.jpg) <br>![](https://codeberg.org/crimeflare/cloudflare-tor/media/branch/master/image/dnsfailtest.jpg) |
| Ug dinhi tingali maghunahuna ka, <br> "Wala ako naggamit sa Tor o VPN, nganong mag-atiman ako?" <br> "Nagsalig ako sa pagpamaligya sa Cloudflare, ngano nga ako kinahanglan mag-amping" <br> "Ang akong website mao ang https ngano nga kinahanglan ko mag-atiman "| ![](https://codeberg.org/crimeflare/cloudflare-tor/media/branch/master/image/annoyed.jpg) |
| Kung nagbisita ka sa website nga gigamit ang Cloudflare, gipaambit nimo ang imong kasayuran dili lamang sa tag-iya sa website kundi usab ang Cloudflare. Ingon niini naglihok ang reverse proxy. | ![](https://codeberg.org/crimeflare/cloudflare-tor/media/branch/master/image/prism_gfe.jpg) |
...
| Ang https ni Cloudflare wala’y katapusan hangtod sa katapusan. | ![](https://codeberg.org/crimeflare/cloudflare-tor/media/branch/master/image/sniff2.gif) |
| Gusto ba nimong ipakigbahin ang imong datos sa Cloudflare, ug usa usab nga ahensya nga 3-sulat? | ![](https://codeberg.org/crimeflare/cloudflare-tor/media/branch/master/image/cfstrengthdata.jpg) |
| Ang profile sa online nga tiggamit sa Internet usa ka "produkto" nga gusto mapalit sa gobyerno ug sa mga dagkung tech nga kompanya. | ![](https://codeberg.org/crimeflare/cloudflare-tor/media/branch/master/image/federalinterest.jpg) |
| Ang Department of Homeland Security sa Estados Unidos nag-ingon: <br> "Adunay ka ba ideya kung unsa ka hinungdanon ang datos nga naa nimo? Adunay ba nga paagi nga ibaligya mo kami sa datos?" | ![](https://codeberg.org/crimeflare/cloudflare-tor/media/branch/master/image/dhssaid.jpg) |
| Nagtanyag usab ang Cloudflare FREE serbisyo sa VPN nga gitawag nga "Cloudflare Warp". Kung gigamit nimo kini, ang tanan nga mga koneksyon sa imong smartphone (o imong computer) gipadala sa mga server sa Cloudflare. Mahibal-an sa Cloudflare kung unsang website ang imong nabasa, kung unsa ang komentaryo nga imong gi-post, kinsa imong nakigsulti, ug uban pa. Boluntaryo ka nga naghatag sa tanan nimo nga kasayuran sa Cloudflare. Kung nagahunahuna ka nga "Nagba-joke ka? Lig-on ang Cloudflare." nan kinahanglan nimo nga mahibal-an kung giunsa ang paglihok sa VPN. | ![](https://codeberg.org/crimeflare/cloudflare-tor/media/branch/master/image/howvpnwork.jpg) |
...
| Ingnon ta nga nagtrabaho ka sa NSA, ug gusto nimo ang matag profile sa internet sa mga lungsuranon. Nahibal-an nimo ang kadaghanan sa mga kini nga wala’y pagsalig sa Cloudflare ug gigamit kini - usa ra ang sentralisado nga gateway - aron pag-proxy sa ilang koneksyon sa server sa kompanya (SSH/RDP), personal nga website, chat website, forum website, website sa bangko, website sa paniguro, search engine, tinago nga miyembro -Bahin nga website, subasta sa website, subasta, pagpamaligya, website sa video, website sa NSFW, ug ilegal nga website. Nahibal-an mo usab nga gigamit nila ang serbisyo sa Cloudflare's DNS ("1.1.1.1") ug serbisyo sa VPN ("Cloudflare Warp") alang sa "Secure! Mas mabilis! Mas maayo!" kasinatian sa internet. Ang paghiusa kanila sa IP address sa gumagamit, fingerprint sa browser, cookies ug RAY-ID mahimong mapuslanon sa pagtukod sa profile sa target sa target. | ![](https://codeberg.org/crimeflare/cloudflare-tor/media/branch/master/image/edw_snow.jpg) |
...
### Libre nga dugos alang sa tanan. _Some_ mga pisi nga gilakip.

![](https://codeberg.org/crimeflare/cloudflare-tor/media/branch/master/image/iminurtls.jpg)

### Ayaw mogamit Cloudflare.
...
Ang kini nga repositoryo usa ka lista sa mga website nga anaa sa luyo sa "_Ang Dakong Cloudwall_", nag-block sa mga tiggamit sa Tor ug uban pang mga CDN.


** Data **
* [Cloudflare Inc.](../cloudflare_inc/)
* [Mga Gumagamit sa Cloudflare](../cloudflare_users/)
* [Mga Pundo sa Cloudflare](../cloudflare_users/domain/)
* [Mga dili Gumagamit sa Cloudflare CDN](../not_cloudflare/)
* [Mga tiggamit sa Anti-Tor](../anti-tor_users/)
...
* Ang icon sa Padlock nagpaila sa usa ka luwas nga koneksyon sa SSL nga gitukod w MITM-ed](https://bugs.debian.org/cgi-bin/bugreport.cgi?bug=831835) ni Anonymous
* [I-block ang Global Active Adversary Cloudflare](https://trac.torproject.org/projects/tor/ticket/24351) pinaagi sa nym-zone
  * Ang tiket gi-vandalize sa daghang beses.
  * Nawagtang sa [Tor Project](https://lists.torproject.org/pipermail/anti-censorship-team/2020-May/000098.html). Kitaa ang [ticket 34175](https://trac.torproject.org/projects/tor/ticket/34175).
  * Katapusan [ticket archive 24351](https://web.archive.org/web/20200301013104/https://trac.torproject.org/projects/tor/ticket/24351)
* [Suliran sa Cloudflare](https://github.com/privacytoolsIO/privacytools.io/issues/374#issuecomment-460077544) ni libBletchley
  * Gigamit na nila kaniadto ang Cloudflare. Gidugang ang CF-tor apan [gikuha kini](https://github.com/privacytools/privacytools.io/pull/1804).
* [Watch sa Cloudflare](http://www.crimeflare.org:82/)
* [Kritikanhon ug kontrobersiya](https://en.wikipedia.org/wiki/Cloudflare#Criticism_and_controversies) ni Wikipedia
* [Ang isa pa ka adlaw nga landmark sa giyera aron makontrol, ma-sentral ug i-censor ang internet.](https://www.reddit.com/r/privacy/comments/b8dptl/another_landmark_day_in_the_war_to_control/) ni TheGoldenGoose8888
* [Ang dili maayo nga pagsalig sa usa lamang ka serbisyo](https://twitter.com/w3Nicolas/status/1134529316904153089) ([DO ang CF](https://www.digwebinterface.com/?hostnames=ns1.digitalocean.com % 0D% 0Ans2.digitalocean.com% 0D% 0Ans3.digitalocean.com% 0D% 0Awww.digitalocean.com & type = A & ns = resolver & useresolver = 8.8.4.4 & nameservers =))
...
* Basaha [ang among lista sa girekomenda nga mga aksyon](unsa-to-do.md) ug ipaambit kini sa imong mga higala.

* Basaha ang [tingog sa ubang user](../PEOPLE.md) ug isulat ang imong mga hunahuna.

* Pagpangita usa ka butang sa [Ansero](https://ansero.wodferndripvpe6ib4uz4rtngrnzichnirgn7t5x64gxcyroopbhsuqd.onion/) ([clearnet](https://ansero.eu.org/)) o [Crimeflare \ #Search](https://crimeflare. wodferndripvpe6ib4uz4rtngrnzichnirgn7t5x64gxcyroopbhsuqd.onion/) ([clearnet](https://crimeflare.eu.org/)).

* Pag-update sa lista sa domain: [Lista sa mga panudlo](mga panudlo.md).
...
* Niini ang pila [PDF/ePUB](../pdf/) aron mabasa.


---

### About sa mga peke nga account

Nahibal-an sa Crimeflare ang mahitungod sa paglungtad sa mga peke nga mga account nga nagpakisayud sa among opisyal nga mga kanal, mao ra ang Twitter, Facebook, Patreon, OpenCollective, Village ug uban pa.
...
# AYAW PAGTUO PAG-LABOT ACCOUNTS.
