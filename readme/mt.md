...
| Cloudflare huwa l-akbar prokura MITM fid-dinja (reverse prokura). Cloudflare għandha aktar minn 80% tas-sehem tas-suq CDN u l-għadd ta 'utenti ta' cloudflare qed jikber kuljum. Huma kabbru n-netwerk tagħhom għal aktar minn 100 pajjiż. Cloudflare jservi aktar traffiku tal-web minn Twitter, Amazon, Apple, Instagram, Bing u Wikipedia. Cloudflare qed joffri pjan b'xejn u ħafna nies qed jużawha minflok ma jikkonfiguraw is-servers tagħhom kif suppost. Huma nnegozjati l-privatezza fuq konvenjenza. | ![](https://codeberg.org/crimeflare/cloudflare-tor/media/branch/master/image/cfmarkshare.jpg) |
...
| Agħti ħarsa lejn l-immaġni t-tajba. Inti taħseb li Cloudflare jimblokka biss guys ħżiena. Inti taħseb li Cloudflare huwa dejjem onlajn (qatt ma jinżel). Għandek taħseb li l-bots leġittimi u t-tkaxkir jistgħu jindikaw il-websajt tiegħek. | ![](https://codeberg.org/crimeflare/cloudflare-tor/media/branch/master/image/howcfwork.jpg) |
...
| Int tassew taħseb li Cloudflare għandu 100% uptime? M'għandek l-ebda idea kemm-il darba Cloudflare jinżel. Jekk Cloudflare jinżel il-klijent tiegħek ma jistax jaċċessa l-websajt tiegħek. | ![](https://codeberg.org/crimeflare/cloudflare-tor/media/branch/master/image/cloudflareinternalerror.jpg) <br>![](https://codeberg.org/crimeflare/cloudflare-tor/media/branch/master/image/cloudflareoutage-2020.jpg) |
| Huwa msejjaħ dan b'referenza għall-Great Firewall taċ-Ċina li tagħmel xogħol komparabbli ta 'filtrazzjoni ta' ħafna bnedmin milli jaraw kontenut tal-web (jiġifieri kulħadd fiċ-Ċina kontinentali u nies barra) filwaqt li fl-istess ħin dawk mhux affettwati jaraw web dratically differenti , web ħielsa miċ-ċensura bħal immaġni ta '"raġel tat-tank" u l-istorja tal- "protesti tal-Pjazza Tiananmen". | ![](https://codeberg.org/crimeflare/cloudflare-tor/media/branch/master/image/cloudflarechina.jpg) |
...
| Ma tistax tgħaddi din il-"verifika tal-browser" invażiva mingħajr ma tippermetti Javascript. Dan huwa ħela ta 'ħames (jew aktar) sekondi tal-ħajja siewja tiegħek. | ![](https://codeberg.org/crimeflare/cloudflare-tor/media/branch/master/image/omsjsck.jpg) |
| Cloudflare awtomatikament jimblokka robots/crawlers leġittimi bħal Google, Yandex, Yacy, u l-klijenti API. Cloudflare qed tissorvelja b'mod attiv il-komunità "bypass cloudflare" bl-intenzjoni li tkisser bots leġittimi ta 'riċerka. | ![](https://codeberg.org/crimeflare/cloudflare-tor/media/branch/master/image/cftestgoogle.jpg) |
...
| Fis-sena 2020 Cloudflare qalbu mir-Recaptcha tal-Google għal hCaptcha hekk kif Google biħsiebu jiċċarġja għall-użu tiegħu. Cloudflare qallek li jimpurtahom il-privatezza tiegħek ("dan ​​jgħin biex jindirizza t-tħassib tal-privatezza") iżda din hija ovvjament gidba. Huwa kollox dwar il-flus. "hCaptcha tippermetti lill-websajts li jagħmlu l-flus li jaqdu din id-domanda waqt li jimblokkaw il-bot u forom oħra ta 'abbuż" <br> Mill-perspettiva ta' l-utent, dan ma jinbidilx ħafna. Int tkun sfurzat issolviha. | ![](https://codeberg.org/crimeflare/cloudflare-tor/media/branch/master/image/fedup_fucking_hcaptcha.jpg) |
...
| Utenti Tor u utenti VPN huma wkoll vittma ta 'Cloudflare. Iż-żewġ soluzzjonijiet qed jintużaw minn ħafna nies li ma jistgħux jaffordjaw internet bla ċensura minħabba l-politika tal-pajjiż/korporazzjoni/netwerk tagħhom jew li jixtiequ jżidu saff żejjed biex jipproteġu l-privatezza tagħhom. Cloudflare qed tattakka bla mistħija lil dawk in-nies, u ġiegħelhom itfu s-soluzzjoni ta 'prokura tagħhom. | ![](https://codeberg.org/crimeflare/cloudflare-tor/media/branch/master/image/banvpn2.jpg) |
| Jekk ma ppruvajtx Tor sa dan il-mument, aħna ninkoraġġukuk tniżżel Tor Browser u żżur il-websajts favoriti tiegħek. (parir: M'għandekx idħol fil-websajt tal-bank jew fil-paġna web tal-gvern jew li se jtajjar il-kont tiegħek. Uża VPN għal dawk il-websajts.) | ![](https://codeberg.org/crimeflare/cloudflare-tor/media/branch/master/image/banvpn.jpg) |
| Tista 'tkun trid tgħid "Tor huwa illegali! L-utenti tat-Tor huma kriminali! Tor huwa ħażin!". Le. Int forsi tgħallimt dwar Tor mit-televiżjoni, li tgħid li Tor jista 'jintuża biex tibbrawżja darknet u tinnegozja pistoli, drogi jew porn chid. Filwaqt li d-dikjarazzjoni hawn fuq hija vera li hemm ħafna websajt tas-suq minn fejn tista 'tixtri oġġetti bħal dawn, dawk is-siti ta' spiss jidhru fuq clearnet ukoll. | ![](https://codeberg.org/crimeflare/cloudflare-tor/media/branch/master/image/whousetor.jpg) |
| Tor ġie żviluppat mill-Armata Amerikana, iżda Tor kurrenti huwa żviluppat mill-proġett Tor. Hemm ħafna nies u organizzazzjonijiet li jużaw Tor inklużi l-ħbieb futuri tiegħek. Allura, jekk qed tuża Cloudflare fuq il-websajt tiegħek qed timblokka bnedmin reali. Int titlef negozju ta 'ħbiberija u negozju potenzjali. | ![](https://codeberg.org/crimeflare/cloudflare-tor/media/branch/master/image/iusetor_alith.jpg) |
| U s-servizz tad-DNS tagħhom, 1.1.1.1, qed jiffiltra wkoll lill-utenti milli jżuru l-websajt billi jirritornaw indirizz IP falz proprjetà ta 'Cloudflare, localhost IP bħal "127.0.0.x", jew sempliċement jirritornaw xejn. | ![](https://codeberg.org/crimeflare/cloudflare-tor/media/branch/master/image/cferr1016.jpg) <br>![](https://codeberg.org/crimeflare/cloudflare-tor/media/branch/master/image/cferr1016sp.jpg) |
| Cloudflare DNS ikisser ukoll software onlajn mill-app smartphone għal-logħba tal-kompjuter minħabba r-risposta falza tagħhom tad-DNS. Cloudflare DNS ma jistax jistaqsi xi websajts tal-bank. | ![](https://codeberg.org/crimeflare/cloudflare-tor/media/branch/master/image/cfdnsprob.jpg) <br>![](https://codeberg.org/crimeflare/cloudflare-tor/media/branch/master/image/dnsfailtest.jpg) |
| U hawn tista 'taħseb, <br> "M'iniex nuża Tor jew VPN, għaliex għandi nieħu ħsieb?" <br> "Jiena nafda s-suq Cloudflare, għaliex għandi nieħu ħsieb" <br> "Il-websajt tiegħi hija https għaliex għandi nieħu ħsieb "| ![](https://codeberg.org/crimeflare/cloudflare-tor/media/branch/master/image/annoyed.jpg) |
...
| Cloudflare's https mhu qatt end-to-end. | ![](https://codeberg.org/crimeflare/cloudflare-tor/media/branch/master/image/sniff2.gif) |
...
| Id-Dipartiment tas-Sigurtà Interna ta 'l-Istati Uniti qal: <br> "Għandek xi idea kemm hi ta' valur id-data li għandek? Hemm xi mod kif tbiegħna dik id-data?" | ![](https://codeberg.org/crimeflare/cloudflare-tor/media/branch/master/image/dhssaid.jpg) |
| Cloudflare joffri wkoll servizz VPN B'XEJN imsejjaħ "Cloudflare Warp". Jekk tużah, il-konnessjonijiet kollha tal-smartphone tiegħek (jew tal-kompjuter tiegħek) jintbagħtu lis-servers Cloudflare. Cloudflare tista 'tkun taf liema websajt qrajt, liema kumment stazzjonajt, ma' min tkellimt, eċċ Int volontarju tagħti l-informazzjoni kollha tiegħek lil Cloudflare. Jekk taħseb "Qed Ċajt? Cloudflare huwa sigur." mela trid titgħallem kif taħdem VPN. | ![](https://codeberg.org/crimeflare/cloudflare-tor/media/branch/master/image/howvpnwork.jpg) |
...
### Cloudflare huwa hotpot.

![](https://codeberg.org/crimeflare/cloudflare-tor/media/branch/master/image/honeypot.gif)

### Għasel b'xejn għal kulħadd. Ċerti kordi mehmuża
...
## Data & Aktar Informazzjoni
</summary>


Dan ir-repożitorju huwa lista ta 'websajts li huma wara "_The Great Cloudwall_", li jimblokka l-utenti Tor u CDNs oħra.
...
* [Utenti ta 'CDN mhux Cloudflare](../not_cloudflare/)
* [Utenti kontra t-Tor](../anti-tor_users/)
...
* [Blokk Globali Avversarju Attiv Globali](https://trac.torproject.org/projects/tor/ticket/24351) minn żona nym
  * Il-biljett kien vandalizzat tant drabi.
  * Imħassar permezz tal- [Proġett Tor](https://lists.torproject.org/pipermail/anti-censorship-team/2020-May/000098.html). Ara [biljett 34175](https://trac.torproject.org/projects/tor/ticket/34175).
...
* [Problema bi Cloudflare](https://github.com/privacytoolsIO/privacytools.io/issues/374#issuecomment-460077544) minn libBletchley
  * Kienu użaw Cloudflare fil-passat. Żied CF-tor iżda [neħħah](https://github.com/privacytools/privacytools.io/pull/1804).
* [Watch Cloudflare](http://www.crimeflare.org:82/)
* [Kritika u kontroversji](https://en.wikipedia.org/wiki/Cloudflare#Criticism_and_controversies) mill-Wikipedija
* [Jum ieħor ta 'mument fil-gwerra biex tikkontrolla, tiċċentralizza u tiċċensura l-internet.](https://www.reddit.com/r/privacy/comments/b8dptl/another_landmark_day_in_the_war_to_control/) minn TheGoldenGoose8888
* [Żvantaġġ li wieħed joqgħod fuq servizz wieħed biss](https://twitter.com/w3Nicolas/status/1134529316904153089) ([DO huwa CF](https://www.digwebinterface.com/?hostnames=ns1.digitalocean.com % 0D% 0Ans2.digitalocean.com% 0D% 0Ans3.digitalocean.com% 0D% 0Awww.digitalocean.com & type = A & ns = riżoluzzjoni & useresolver = 8.8.4.4 & nameservers =))
...
* Fittex xi ħaġa fuq [Ansero](https://ansero.wodferndripvpe6ib4uz4rtngrnzichnirgn7t5x64gxcyroopbhsuqd.onion/) ([clearnet](https://ansero.eu.org/)) jew [Crimeflare \ #Search](https://crimeflare. wodferndripvpe6ib4uz4rtngrnzichnirgn7t5x64gxcyroopbhsuqd.onion/) ([clearnet](https://crimeflare.eu.org/)).

* [Aġġorna l-lista tad-domain: l-istruzzjonijiet tal-lista](istruzzjonijiet.md).

* [Żid Cloudflare jew avveniment relatat mal-proġett mal-istorja](../HISTORY.md).

* Ipprova u jikteb ġdid [Għodda/Skript](għodda/).

* Hawn xi [PDF/ePUB](../pdf/) biex taqra.
...
Aħna qatt ma nitolbok issegwi l-midja soċjali.
Aħna qatt ma nitolbu l-midja soċjali tiegħek. **

# MA TIDDEFIDIXXI KONTI FAKE.
