...
| Cloudflare gelek kesan li seranserê cîhanê aciz dike. Li nav navnîşê binihêrin û bifikirin gelo pêkanîna Cloudflare li ser malpera we ji bo ezmûna bikarhêner baş e. | ![](https://codeberg.org/crimeflare/cloudflare-tor/media/branch/master/image/omsstream.jpg) |
...
Vê repoya navnîşek malperên ku li pişt "_The Great Cloudwall_" in, rawestandina bikarhênerên Tor û CDNên din e.
...
* [Bikarhênerên dijî-Tor](dij-tor_users/)
...
* [Cloudwall ya Mezin](got.txt) ji hêla [Mr. Jeff Cliff](https://shitposter.club/users/jeffcliff)
  ...
  * Ji ber binpêkirina copyright a materyalê CC0, eBookê (ePUB) ya bingehîn ji hêla BookRix GmbH ve hate jêbirin.
* [Iconkona Padlock girêdanek SSL-ya ewledar a ku bi MITM-ed hatî damezrandin nîşan dide](https://bugs.debian.org/cgi-bin/bugreport.cgi?bug=831835) Ji hêla Anonymous ve
* [Cloudflare Adversary Global Active Active Ad Blockary](https://trac.torproject.org/projects/tor/ticket/24351) by nym-zone
  * Bilêt gelek caran hate taloqkirin.
  ...
  * Dawîn [bilêtê arşîvê 24351](https://web.archive.org/web/20200301013104/https://trac.torproject.org/projects/tor/ticket/24351)
* [Pirsgirêka Cloudflare](https://github.com/privacytoolsIO/privacytools.io/issues/374#issuecomment-460077544) by libBletchley
  * Wan berê Cloudflare bikar anîn. CF-tor lê zêde kir lê [ew rakirin](https://github.com/privacytools/privacytools.io/pull/1804).
* [Watch Cloudflare](http://www.crimeflare.org:82/)
* [Rexnekirin û nakokî](https://en.wikipedia.org/wiki/Cloudflare#Criticism_and_controversies) by Wikipedia
* [Rojnameyek din di şer de ji bo kontrolkirin, navendîkirin û sansûrkirina înternetê.) (https://www.reddit.com/r/privacy/comments/b8dptl/another_landmark_day_in_the_war_to_control/) by TheGoldenGoose8888
* [Benda kêmasiya bi tenê yek karûbar ve girêdayî ye](https://twitter.com/w3Nicolas/status/1134529316904153089) ([DO DO CF](https://www.digwebinterface.com/?hostnames=ns1.digitalocean.com % 0D% 0Ans2.digitalocean.com% 0D% 0Ans3.digitalocean.com% 0D% 0Awww.digitalocean.com & celeb = A & ns = çareserker & Useresolver = 8.8.4.4 & navdêrên xwerû =))
...
* Li tiştek [Ansero](https://ansero.wodferndripvpe6ib4uz4rtngrnzichnirgn7t5x64gxcyroopbhsuqd.onion/) bigerin () ([clearnet](https://ansero.eu.org/)) an [Crimeflare \ #Search](https://sûreflare wodferndripvpe6ib4uz4rtngrnzichnirgn7t5x64gxcyroopbhsuqd.onion/) ([clearnet](https://crimeflare.eu.org/).

* [Navnîşa domainê nûve bikin: Rêbernameyên navnîşan](rêwerzan.md).

* [Cloudflare an bûyerê têkildarî projeyê bi dîrokê ve zêde bike](../HISTORY.md).

* [../tool/Script] nû (amûr/) bikar bînin û binivîsin.

* Li vir hin [PDF/ePUB](../pdf/) tê xwendin.


---

### About hesabên derewîn
...
Em tu carî ji medyaya weya civakî napirsin. **

# NAVNETN NCONE BBNE BIKIN.
