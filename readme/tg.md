...
|  🖹  |  🖼 |
| --- | --- |
|  "The Cloudwall Бузург" ин Cloudflare Inc., ширкати ИМА мебошад.Он хидматҳои CDN (шабакаи таҳвили мундариҷа), коҳиши DDoS, амнияти интернет ва хидматҳои тақсимшудаи DNS (сервери ном) -ро пешкаш мекунад.  |  ![](https://codeberg.org/crimeflare/cloudflare-tor/media/branch/master/image/cloudflaredearuser.jpg) |
|  Cloudflare прокси калонтарини MITM дар ҷаҳон (прокси баръакс) мебошад.Cloudflare беш аз 80% ҳиссаи бозори CDN дорад ва шумораи корбарони Cloudflar рӯз аз рӯз меафзояд.Онҳо шабакаи худро ба беш аз 100 кишвар густариш доданд.Cloudflare назар ба Twitter, Amazon, Apple, Instagram, Bing ва Википедия трафики бештари траффики веб хизмат мекунад.Cloudflare нақшаи ройгонро пешкаш мекунад ва бисёриҳо ба ҷои ба танзим даровардани серверҳои худ аз он истифода мебаранд.Онҳо ба манзил нигоҳ доштани махфиятро ба даст оварданд.  |  ![](https://codeberg.org/crimeflare/cloudflare-tor/media/branch/master/image/cfmarketshare.jpg)  |
...
|  Cloudflare дорои қудрати бузург аст.Ба маъное, онҳо назорат мекунанд, ки чӣ корбари ниҳоӣ мебинад.Аз сабаби Cloudflare ба шумо дастрас шудани вебсайтро пешгирӣ мекунанд. | ![](https://codeberg.org/crimeflare/cloudflare-tor/media/branch/master/image/onemorestep.jpg) |
...
|  Шумо наметавонед ин "тафтиши браузер" -ро бидуни фаъолсозии Javascript гузаред.Ин панҷ (ё зиёда) сонияи ҳаёти пурарзиши худро хароб мекунад. | ![](https://codeberg.org/crimeflare/cloudflare-tor/media/branch/master/image/omsjsck.jpg) |
|  Cloudflare инчунин роботҳо / креперҳои қонуниро ба монанди Google, Yandex, Yacy ва API муштариён ба таври худкор блок мекунад.Cloudflare ҷомеаи "bypass cloudflare" -ро фаъолона пайгирӣ намуда, бо мақсади шикастани нуқтаҳои қонунии тадқиқотӣ машғул аст. | ![](https://codeberg.org/crimeflare/cloudflare-tor/media/branch/master/image/cftestgoogle.jpg)<br>![](https://codeberg.org/crimeflare/cloudflare-tor/media/branch/master/image/htmlalertcloudflare2.jpg) |
...
|  Дар соли 2020 Cloudflare аз Recaptcha Google ба hCaptcha гузашт, зеро Google мехоҳад барои истифодаи он пардохт кунад.Cloudflare ба шумо гуфт, ки онҳо махфияти шуморо ҳимоя мекунанд ("он ба ҳалли масъалаи махфият кумак мекунад"), аммо ин бешубҳа дурӯғ аст.Ин ҳама пул аст."HCaptcha ба сайтҳо имкон медиҳад, ки ба ин талабот хидмат намоянд, то ки ботҳо ва дигар шаклҳои таҳқирро пешгирӣ кунанд" | ![](https://codeberg.org/crimeflare/cloudflare-tor/media/branch/master/image/fedup_fucking_hcaptcha.jpg) |
|  Аз нуқтаи назари корбар, ин чандон тағйир намеёбад. Шумо маҷбур ҳастед, ки онро ҳал кунед. | ![](https://codeberg.org/crimeflare/cloudflare-tor/media/branch/master/image/hcaptcha_abrv.jpg)<br>![](https://codeberg.org/crimeflare/cloudflare-tor/media/branch/master/image/hcaptcha_chrome.jpg) |
...
|  Агар шумо ба вебсайте ворид шавед, ки Cloudflare-ро истифода мебарад, шумо на танҳо маълумоти соҳиби вебсайтро, балки Cloudflare-ро низ мубодила мекунед.Чунин аст прокси баръакс. | ![](https://codeberg.org/crimeflare/cloudflare-tor/media/branch/master/image/prism_gfe.jpg) |
...
|  Https Cloudflare ҳеҷ гоҳ хотима намеёбад. | ![](https://codeberg.org/crimeflare/cloudflare-tor/media/branch/master/image/sniff2.gif) |
|  Оё шумо дар ҳақиқат мехоҳед маълумоти худро бо Cloudflare ва инчунин агенти 3 ҳарфӣ мубодила кунед? | ![](https://codeberg.org/crimeflare/cloudflare-tor/media/branch/master/image/cfstrengthdata.jpg) |
...
|  Департаменти амнияти дохилии ИМА гуфт:<br><br>Оё шумо ягон тасаввуроте доред, ки маълумоти додашуда то чӣ андоза арзишманд аст? Ягон роҳе ҳаст, ки ин маълумотро ба мо мефурӯшед?  | ![](https://codeberg.org/crimeflare/cloudflare-tor/media/branch/master/image/dhssaid.jpg) |
...
|  Cloudflare гуфтанд, ки хидмати VPN онҳо интернети шуморо тезтар месозад.Аммо VPN пайвасти интернети шуморо нисбат ба пайвасти мавҷудаи шумо сусттар мекунад. | ![](https://codeberg.org/crimeflare/cloudflare-tor/media/branch/master/image/notfastervpn.jpg) |
...
* [Problem with Cloudflare](https://github.com/privacytoolsIO/privacytools.io/issues/374#issuecomment-460077544), libBletchley
  * Онҳо дар гузашта Cloudflare-ро истифода мекарданд.CF-tor хориҷ карда шуд.
...
* Чизеро ҷустуҷӯ кунед: [Ansero](https://ansero.wodferndripvpe6ib4uz4rtngrnzichnirgn7t5x64gxcyroopbhsuqd.onion/) ([clearnet](https://ansero.eu.org/)), [Crimeflare \#Search](https://crimeflare.wodferndripvpe6ib4uz4rtngrnzichnirgn7t5x64gxcyroopbhsuqd.onion/) ([clearnet](https://crimeflare.eu.org/))
