...
| Cloudflare je dejal, da njihova storitev VPN omogoča hiter internet. Toda VPN vašo internetno povezavo naredi počasnejšo od obstoječe. | ![](https://codeberg.org/crimeflare/cloudflare-tor/media/branch/master/image/notfastervpn.jpg) |
...
## Podatki in dodatne informacije
</summary>


To skladišče je seznam spletnih mest, ki stojijo za "_ Great Cloudwall_" in blokirajo Tor-ove uporabnike in druge CDN-je.


** Podatki **
* [Cloudflare Inc.](../cloudflare_inc/)
* [Uporabniki Cloudflare](../cloudflare_users/)
* [Domene Cloudflare](../cloudflare_users/domene/)
* [CDN uporabniki, ki niso v oblaku](../not_cloudflare/)
* [Anti-Tor uporabniki](../anti-tor_users/)
...
* [Blokiraj globalni aktivni nasprotnik Cloudflare](https://trac.torproject.org/projects/tor/ticket/24351) avtorja nym-zone
  * Vstopnica je bila tolikokrat vandalizirana.
  * Izbrisal [Tor Project](https://lists.torproject.org/pipermail/anti-censorship-team/2020-May/000098.html). Glej [vozovnica 34175](https://trac.torproject.org/projects/tor/ticket/34175).
...
* [Težava z Cloudflare](https://github.com/privacytoolsIO/privacytools.io/isissue/374#issuecomment-460077544) avtor libBletchley
  * V preteklosti so uporabljali Cloudflare. Dodan je CF-tor, vendar [ga je odstranil](https://github.com/privacytools/privacytools.io/pull/1804).
* [Cloudflare Watch](http://www.crimeflare.org:82/)
* [Kritike in polemike](https://en.wikipedia.org/wiki/Cloudflare#Criticism_and_controversies) Wikipedia
* [Še en pomemben dan v vojni za nadzor, centralizacijo in cenzuro interneta.](https://www.reddit.com/r/privacy/comments/b8dptl/another_landmark_day_in_the_war_to_control/) avtorja TheGoldenGoose8888
* [Slabost zanašanja na samo eno storitev](https://twitter.com/w3Nicolas/status/1134529316904153089) ([DO je CF](https://www.digwebinterface.com/?hostnames=ns1.digitalocean.com % 0D% 0Ans2.digitalocean.com% 0D% 0Ans3.digitalocean.com% 0D% 0Awww.digitalocean.com & type = A & ns = resoluver & useresolver = 8.8.4.4 & nameservers =))
...
* [Preberite naš seznam priporočenih dejanj in ga delite s prijatelji](kaj-to-do.md)

* [Preberite glas drugega uporabnika in napišite svoje misli](../PEOPLE.md)

* Poiščite nekaj v [Ansero](https://ansero.wodferndripvpe6ib4uz4rtngrnzichnirgn7t5x64gxcyroopbhsuqd.onion/) ([clearnet](https://ansero.eu.org/)) ali [Crimeflare \ #Search](https://Crimeflare. wodferndripvpe6ib4uz4rtngrnzichnirgn7t5x64gxcyroopbhsuqd.onion/) ([clearnet](https://crimeflare.eu.org/)).

* [Posodobi seznam domen: Navodila za seznam](navodila.md).

* [Dodaj zgodovino Cloudflare ali projekt, povezan z projektom](../HISTORY.md).

* Poskusite in napišite novo [Orodje/skript](orodje/).

* Tukaj je nekaj [PDF/ePUB](../pdf/) za branje.
...
Nikoli vas ne prosimo, da sledite na družbenih medijih.
