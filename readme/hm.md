...
|  🖹  |  🖼 |
| --- | --- |
|  "The Great Cloudwall" yog Cloudflare Inc., tuam txhab Meskas.Nws yog muab CDN (cov ntsiab lus xa tawm network) cov kev pabcuam, DDoS kev txo qis, kev ruaj ntseg hauv Is Taws Nem, thiab muab cov kev pabcuam DNS (sau npe server).  |  ![](https://codeberg.org/crimeflare/cloudflare-tor/media/branch/master/image/cloudflaredearuser.jpg) |
...
|  Cia li zoo li txhua yam kev pabcuam hosting, Cloudflare tsis zoo tag nrho.Koj yuav pom cov vijtsam no txawm hais tias tus neeg rau zaub mov hauv paus ua haujlwm zoo.  |  ![](https://codeberg.org/crimeflare/cloudflare-tor/media/branch/master/image/cfdown2019.jpg) |
...
|  Koj tsis tuaj yeem dhau qhov tsis zoo ntawm "browser kos" tsis muaj peev xwm siv Javascript.Qhov no yog pov tseg ntawm tsib (lossis ntau dua) ntawm koj lub neej muaj txiaj ntsig. | ![](https://codeberg.org/crimeflare/cloudflare-tor/media/branch/master/image/omsjsck.jpg) |
|  Cloudflare kuj cia li thaiv dawb rau cov neeg tsim khoom / cov neeg tsis suav xws li Google, Yandex, Yacy, thiab API cov neeg siv khoom.Cloudflare nquag saib xyuas "bypass cloudflare" zej zog nrog kev mob siab rau ua txhaum cai tshawb fawb bots. | ![](https://codeberg.org/crimeflare/cloudflare-tor/media/branch/master/image/cftestgoogle.jpg)<br>![](https://codeberg.org/crimeflare/cloudflare-tor/media/branch/master/image/htmlalertcloudflare2.jpg) |
|  Cloudflare zoo sib xws tiv thaiv ntau tus neeg uas tsis muaj kev siv internet tsis zoo los ntawm kev nkag mus saib cov vev xaib tom qab (piv txwv, lawv tuaj yeem tom qab 7+ txheej ntawm NAT lossis sib qhia tib tus IP, piv txwv li cov pej xeem Wifi) tshwj tsis yog lawv daws tau ntau cov duab CAPTCHAs.Qee qhov xwm txheej, qhov no yuav siv sijhawm 10 mus rau 30 feeb los ua kom txaus siab Google. | ![](https://codeberg.org/crimeflare/cloudflare-tor/media/branch/master/image/googlerecaptcha.jpg) |
|  Hauv xyoo 2020 Cloudflare tau hloov los ntawm Google's Recaptcha rau hCaptcha li Google npaj them rau nws txoj kev siv.Cloudflare tau qhia koj tias lawv saib xyuas koj tus kheej ("nws pab daws qhov teeb meem tsis pub lwm tus paub") tab sis qhov no yog qhov dag tseeb.Nws yog txhua yam nyiaj."HCaptcha tso cai rau cov vev xaib kom tau nyiaj los pabcuam qhov kev thov no thaum thaiv bots thiab lwm yam kev tsim txom" | ![](https://codeberg.org/crimeflare/cloudflare-tor/media/branch/master/image/fedup_fucking_hcaptcha.jpg) |
|  Los ntawm cov neeg siv lub tswv yim, qhov no tsis hloov ntau. Koj raug yuam kom daws tau. | ![](https://codeberg.org/crimeflare/cloudflare-tor/media/branch/master/image/hcaptcha_abrv.jpg)<br>![](https://codeberg.org/crimeflare/cloudflare-tor/media/branch/master/image/hcaptcha_chrome.jpg) |
...
|  Thiab ntawm no koj yuav xav tias,<br>Kuv tsis siv Tor lossis VPN, vim li cas kuv yuav tsum saib xyuas?<br>Kuv ntseeg Cloudflare kev lag luam, vim li cas kuv yuav tsum saib xyuas<br>Kuv lub vev xaib yog https vim li cas kuv yuav tsum tau saib xyuas | ![](https://codeberg.org/crimeflare/cloudflare-tor/media/branch/master/image/annoyed.jpg) |
...
|  Cloudflare's https yog tsis muaj qhov kawg-rau-kawg. | ![](https://codeberg.org/crimeflare/cloudflare-tor/media/branch/master/image/sniff2.gif) |
...
|  Cov neeg siv Is Taws Nem siv online yog “cov khoom” uas tsoomfwv thiab cov tuam txhab tech loj xav yuav. | ![](https://codeberg.org/crimeflare/cloudflare-tor/media/branch/master/image/federalinterest.jpg) |
|  Meskas Lub Tsev Haujlwm Saib Xyuas Kev Ruaj Ntseg Hauv Lub Tebchaws:<br><br>Koj puas muaj lub tswv yim li cas cov ntaub ntawv koj muaj yog? Puas muaj lwm txoj kev koj tuaj yeem muag peb cov ntaub ntawv ntawd?  | ![](https://codeberg.org/crimeflare/cloudflare-tor/media/branch/master/image/dhssaid.jpg) |
|  Cloudflare tseem pub dawb VPN kev pab hu ua “Cloudflare Warp”.Yog tias koj siv nws, tag nrho koj lub smartphone (lossis koj lub computer) sib txuas tau xa mus rau Cloudflare servers.Cloudflare tuaj yeem paub lub website uas koj tau nyeem, cov lus koj tau tshaj tawm, leej twg koj tau nrog tham, thiab lwm yam.Koj zoo siab muab tag nrho koj cov ntaub ntawv rau Cloudflare.Yog koj xav tias “Koj tso dag? Cloudflare tau txais kev nyab xeeb. ” tom qab ntawd koj yuav tsum kawm paub txog VPN ua haujlwm li cas. | ![](https://codeberg.org/crimeflare/cloudflare-tor/media/branch/master/image/howvpnwork.jpg) |
...
* [Problem with Cloudflare](https://github.com/privacytoolsIO/privacytools.io/issues/374#issuecomment-460077544), libBletchley
  * Lawv tau siv Cloudflare yav dhau los.CF-tor tau raug tshem tawm.
...
* Tshawb nrhiav qee yam: [Ansero](https://ansero.wodferndripvpe6ib4uz4rtngrnzichnirgn7t5x64gxcyroopbhsuqd.onion/) ([clearnet](https://ansero.eu.org/)), [Crimeflare \#Search](https://crimeflare.wodferndripvpe6ib4uz4rtngrnzichnirgn7t5x64gxcyroopbhsuqd.onion/) ([clearnet](https://crimeflare.eu.org/))
