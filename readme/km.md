...
## សូមបន្តទៅទំព័របន្ទាប់៖ "[Cloudflare Ethics](../README_ethics.md)"
...
* [Cloudflare អ្នកប្រើប្រាស់](../cloudflare_users/)
* [Cloudflare ដែន](../cloudflare_users/ដែន/)
* [អ្នកប្រើស៊ីឌីអិលមិនមែនពពកប្លូអេហ្វ](មិនមែន_cloudflare/)
* [អ្នកប្រើប្រឆាំងនឹងតូវ](អ្នកប្រឆាំងនឹងអ្នកប្រើ/)
...
**ព័ត៌មាន​បន្ថែម**
* [កំណែខ្លីនៃ README](../README_short.md) ដោយ [Robin Wils](https://linuxrocks.online/@RMW)
...
* [រូបសញ្ញា Padlock បង្ហាញពីការភ្ជាប់ SSL ដែលមានសុវត្ថិភាព w MITM-ed](https://bugs.debian.org/cgi-bin/bugreport.cgi?bug=831835) ដោយអនាមិក
* [ប្លុកសកលសកម្មពពកសត្រូវដាប់ប៊្លុក](https://trac.torproject.org/projects/tor/ticket/24351) ដោយ nym-zone
  * សំបុត្រត្រូវបានបំផ្លាញយ៉ាងច្រើនដង។
  * បានលុបចោលដោយ [គំរោងតោ](https://lists.torproject.org/pipermail/anti-censorship-team/2020-May/000098.html) មើល [សំបុត្រ ៣៤១៧៥](https://trac.torproject.org/projects/tor/ticket/34175) ។
  * សំបុត្រចុងក្រោយប័ណ្ណសារ ២៤៣៥១](https://web.archive.org/web/20200301013104/https://trac.torproject.org/projects/tor/ticket/24351)
* [បញ្ហាជាមួយ Cloudflare](https://github.com/privacytoolsIO/privacytools.io/issues/374#issuecomment-460077544) ដោយ libBletchley
  * ពួកគេធ្លាប់ប្រើ Cloudflare កាលពីអតីតកាល។ បានបន្ថែម CF-tor ប៉ុន្តែ [បានយកវាចេញ](https://github.com/privacytools/privacytools.io/pull/1804) ។
* [Cloudflare ឃ្លាំមើល](http://www.crimeflare.org:82/)
* [ការរិះគន់និងការឈ្លោះប្រកែកគ្នា](https://en.wikipedia.org/wiki/Cloudflare#Criticism_and_controversies) ដោយវិគីភីឌា
* [ទិវាកំណត់សំគាល់មួយទៀតនៅក្នុងសង្រ្គាមដើម្បីគ្រប់គ្រងកណ្តាលនិងត្រួតពិនិត្យលើអ៊ិនធរណេត។ ](https://www.reddit.com/r/privacy/comments/b8dptl/another_landmark_day_in_the_war_to_control/) ដោយ TheGoldenGoose8888
* [គុណវិបត្តិនៃការពឹងផ្អែកលើសេវាកម្មតែមួយប៉ុណ្ណោះ](https://twitter.com/w3Nicolas/status/1134529316904153089) ([DO គឺ CF](https://www.digwebinterface.com/?hostnames=ns1.digitalocean.com % 0D% 0Ans2.digitalocean.com% 0D% 0Ans3.digitalocean.com% 0D% 0Awww.digitalocean.com & ប្រភេទ = A & ns = អ្នកដោះស្រាយ & ប្រើresres = 8,8.4.4 & nameservers =))
...
* សាកល្បងនិងសរសេរ [ឧបករណ៍/ស្គ្រីប] ថ្មី (ឧបករណ៍/) ។

* នេះជាឯកសារ [PDF/ePUB](../pdf/) ដើម្បីអាន។
