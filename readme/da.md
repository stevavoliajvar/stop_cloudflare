...
Denne opbevaring er en liste over websteder, der ligger bag "_The Great Cloudwall_", der blokerer Tor-brugere og andre CDN'er.
...
* [The Great Cloudwall](../pdf/2019-Jeff_Cliff_Book1.txt) af [Mr. Jeff Cliff](https://shitposter.club/users/jeffcliff)
  * Download som: PDF [her](../pdf/2019-The_Great_Cloudwall.pdf), ePUB [her](../pdf/2019-Jeff_Cliff_The_Great_Cloudwall.epub)
  * Den originale e-bog (ePUB) blev slettet af BookRix GmbH på grund af krænkelse af copyright af CC0-materiale
* [Hængelåsikon angiver en sikker SSL-forbindelse oprettet w MITM-ed](https://bugs.debian.org/cgi-bin/bugreport.cgi?bug=831835) af Anonym
* [Bloker Global Active Adversary Cloudflare](https://trac.torproject.org/projects/tor/ticket/24351) af nym-zone
...
* [Problem med Cloudflare](https://github.com/privacytoolsIO/privacytools.io/issues/374#issuecomment-460077544) af libBletchley
  * De havde brugt Cloudflare i fortiden. Tilføjet CF-tor men [fjernet den](https://github.com/privacytools/privacytools.io/pull/1804).
* [Cloudflare Watch](http://www.crimeflare.org:82/)
* [Kritik og kontroverser](https://en.wikipedia.org/wiki/Cloudflare#Criticism_and_controversies) af Wikipedia
* [En anden vartegn dag i krigen for at kontrollere, centralisere og censurere internettet.](https://www.reddit.com/r/privacy/comments/b8dptl/another_landmark_day_in_the_war_to_control/) af TheGoldenGoose8888
* [Ulempen ved kun at stole på en tjeneste](https://twitter.com/w3Nicolas/status/1134529316904153089) ([DO er CF](https://www.digwebinterface.com/?hostnames=ns1.digitalocean.com % 0D% 0Ans2.digitalocean.com% 0D% 0Ans3.digitalocean.com% 0D% 0Awww.digitalocean.com & type = A & ns = resolver & useresolver = 8.8.4.4 & navneservere =))
...
* Læs [vores liste over anbefalede handlinger](../ACTION.md), og del den med dine venner.

* Læs [anden brugers stemme](../PEOPLE.md), og skriv dine tanker.

* Søg noget på [Ansero](https://ansero.wodferndripvpe6ib4uz4rtngrnzichnirgn7t5x64gxcyroopbhsuqd.onion/) ([clearnet](https://ansero.eu.org/)) eller [Crimeflare \ #Search](https://crimeflare. wodferndripvpe6ib4uz4rtngrnzichnirgn7t5x64gxcyroopbhsuqd.onion/) ([clearnet](https://crimeflare.eu.org/)).

* Opdater domænelisten: [Listeinstruktioner](instruktioner.md).

* Føj Cloudflare eller projektrelateret begivenhed til [history](../HISTORY.md).

* Prøv & skriv nyt [Værktøj/script](værktøj/).

* Her er nogle [PDF/ePUB](../pdf/) at læse.
...
Vi beder aldrig din anmeldelse.
