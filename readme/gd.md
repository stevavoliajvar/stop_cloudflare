...
Is e an ath-reic seo liosta de làraich-lìn a tha air cùl "_The Great Cloudwall_", a ’bacadh luchd-cleachdaidh Tor agus CDNan eile.


** Dàta **
* [Cloudflare Inc.](../cloudflare_inc/)
* [Luchd-cleachdaidh Cloudflare](../cloudflare_users/)
* [Fearann ​​Cloudflare](../cloudflare_users/raointean/)
* [Luchd-cleachdaidh CDN neo-Cloudflare](../not_cloudflare/)
* [Luchd-cleachdaidh anti-Tor](../anti-tor_users/)
...
* [Block Global Adversary Cloudflare](https://trac.torproject.org/projects/tor/ticket/24351) a rèir nym-zone
  * Chaidh an tiogaid a mhilleadh cho tric.
  * Air a dhubhadh às leis an [Tor Project](https://lists.torproject.org/pipermail/anti-censorship-team/2020-May/000098.html). Faic [tiogaid 34175](https://trac.torproject.org/projects/tor/ticket/34175).
  * Mu dheireadh [tiogaid tasglann 24351](https://web.archive.org/web/20200301013104/https://trac.torproject.org/projects/tor/ticket/24351)
* [Duilgheadas le Cloudflare](https://github.com/privacytoolsIO/privacytools.io/issues/374#issuecomment-460077544) le libBletchley
  * Bha iad air Cloudflare a chleachdadh roimhe seo. Chuir CF-tor ris ach [chuir e air falbh e](https://github.com/privacytools/privacytools.io/pull/1804).
* [Freiceadan Cloudflare](http://www.crimeflare.org:82/)
* [Breithneachadh agus connspaidean](https://en.wikipedia.org/wiki/Cloudflare#Criticism_and_controversies) le Wikipedia
* [Latha sònraichte eile sa chogadh gus smachd a chumail air, meadhanachadh agus censachadh an eadar-lìn.](https://www.reddit.com/r/privacy/comments/b8dptl/another_landmark_day_in_the_war_to_control/) le TheGoldenGoose8888
* [Eas-bhuannachd a bhith an urra ri dìreach aon sheirbheis](https://twitter.com/w3Nicolas/status/1134529316904153089) ([DO is CF](https://www.digwebinterface.com/?hostnames=ns1.digitalocean.com % 0D% 0Ans2.digitalocean.com% 0D% 0Ans3.digitalocean.com% 0D% 0Awww.digitalocean.com & type = A & ns = resolver & useresolver = 8.8.4.4 & nameservers =))
...
* Rannsaich rudeigin air [Ansero](https://ansero.wodferndripvpe6ib4uz4rtngrnzichnirgn7t5x64gxcyroopbhsuqd.onion/) ([clearnet](https://ansero.eu.org/)) no [Crimeflare \ #Search](https://Crimeflare. wodferndripvpe6ib4uz4rtngrnzichnirgn7t5x64gxcyroopbhsuqd.onion/) ([clearnet](https://crimeflare.eu.org/)).

* Ùraich an liosta fearainn: [Stiùireadh liosta](stiùiridhean.md).

* Cuir Cloudflare no tachartas co-cheangailte ris a ’phròiseact gu [eachdraidh](../HISTORY.md).

* Feuch & sgrìobh ùr [Inneal/Sgriobt](inneal/).

* Seo cuid [PDF/ePUB](../pdf/) ri leughadh.
...
** Cha bhi sinn uair sam bith ag iarraidh do phost-d.
...
# NA URRAINN CUNNTAS AIR FAIGHINN.
