...
מאגר זה הוא רשימה של אתרי אינטרנט העומדים מאחורי "_ The Cloudwall_" הגדול, וחוסם את משתמשי Tor ו- CDNs אחרים.


**נתונים**
* [Cloudflare Inc.](../cloudflare_inc/)
* [משתמשי Cloudflare](../cloudflare_users/)
* [תחומי ענן ענן](../cloudflare_users/domains/)
* [משתמשי CDN שאינם עננים פרחים](../not_cloudflare/)
* [משתמשי אנטי טור](אנטי טור_וסרים/)
...
* [חסימת Cloudflare Cloud Active Adversary Global](https://trac.torproject.org/projects/tor/ticket/24351) מאת nym-zone
  * הכרטיס הושחת כל כך הרבה פעמים.
  * נמחק על ידי [פרויקט Tor](https://lists.torproject.org/pipermail/anti-censorship-team/2020-May/000098.html). ראה [כרטיס 34175](https://trac.torproject.org/projects/tor/ticket/34175).
  * אחרון [כרטיס ארכיב 24351](https://web.archive.org/web/20200301013104/https://trac.torproject.org/projects/tor/ticket/24351)
* [בעיה עם Cloudflare](https://github.com/privacytoolsIO/privacytools.io/issues/374#issuecomment-460077544) מאת libBletchley
  * הם השתמשו ב- Cloudflare בעבר. הוסיף CF-tor אך [הסיר אותו](https://github.com/privacytools/privacytools.io/pull/1804).
* [Cloudflare Watch](http://www.crimeflare.org:82/)
* [ביקורת וסכסוכים](https://en.wikipedia.org/wiki/Cloudflare#Criticism_and_controversies) מאת Wikipedia
* [יום ציון דרך נוסף במלחמה לשליטה, ריכוז וצנזורה באינטרנט.](https://www.reddit.com/r/privacy/comments/b8dptl/another_landmark_day_in_the_war_to_control/) מאת TheGoldenGoose8888
* [החיסרון בהסתמכות על שירות אחד בלבד](https://twitter.com/w3Nicolas/status/1134529316904153089) ([DO הוא CF](https://www.digwebinterface.com/?hostnames=ns1.digitalocean.com % 0D% 0Ans2.digitalocean.com% 0D% 0Ans3.digitalocean.com% 0D% 0Awww.digitalocean.com & type = A & ns = resolver & useresolver = 8.8.4.4 & nameservers =))
...
* קרא [רשימת הפעולות המומלצות שלנו](../what-to-do.md) ושתף אותה עם חבריך.

* קרא את [קולו של משתמש אחר](../PEOPLE.md) וכתוב את מחשבותיך.
...
* נסה וכתוב [כלי/סקריפט] חדש (כלי/).

להלן כמה [PDF/ePUB](../pdf/) לקריאה.


---

### אודות חשבונות מזויפים
...
** אנחנו אף פעם לא שואלים את הדוא"ל שלך.
...
לעולם לא נשאל את המדיה החברתית שלך. **
